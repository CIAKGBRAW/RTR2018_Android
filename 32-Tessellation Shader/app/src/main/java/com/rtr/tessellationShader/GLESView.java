    ...
    private void initialize() {
        ...
        if (iShaderCompileStatus[0] == GLES32.GL_FALSE) {
            ...
            if (iInfoLogLength[0] > 0) {
                ...
                System.out.println("RTR: Tessellation Control Shader: " + szInfo);
                uninitialize();
                System.exit(0);
            }
        }
        ...
        if (iShaderCompileStatus[0] == GLES32.GL_FALSE) {
            ...
            if (iInfoLogLength[0] > 0) {
                ...
                System.out.println("RTR: Tessellation Evaluation Shader: " + szInfo);
                uninitialize();
                System.exit(0);
            }
        }
        ...
        System.out.println("RTR: Uniform mvp: " + mvpUniform);
        System.out.println("RTR: Uniform gNumberOfSegmentsUniform: " + gNumberOfSegmentsUniform);
        System.out.println("RTR: Uniform gNumberOfStripsUniform: " + gNumberOfStripsUniform);
        System.out.println("RTR: Uniform gLineColorUniform: " + gLineColorUniform);
