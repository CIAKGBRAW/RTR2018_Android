    ...
    private void initialize() {
        ...
        if (iShaderCompileStatus[0] == GLES32.GL_FALSE) {
            ...
            if (iInfoLogLength[0] > 0) {
                ...
                System.out.println("RTR: Vertex Shader FBO: " + szInfo);
                uninitialize();
                System.exit(0);
            }
        ...
        if (iShaderCompileStatus[0] == GLES32.GL_FALSE) {
            ...
            if (iInfoLogLength[0] > 0) {
                ...
                System.out.println("RTR: Fragment Shader FBO: " + szInfo);
                uninitialize();
                System.exit(0);
            }
        }
        ...
        GLES32.glBindAttribLocation(shaderProgramObject_FBO, GLESMacros.AMC_ATTRIBUTE_TEXCOORD0, "vTexcoord");
        ...
        if (iProgramLinkStatus[0] == GLES32.GL_FALSE)
        {
            ...
            if (iInfoLogLength[0] > 0)
            {
                ...
                System.out.println("RTR: FBO Program Linking: " + szInfo);
                uninitialize();
                System.exit(0);
            }
        }
        ...
        // System.out.println("RTR: Framebuffer status: ");
        // System.out.println("RTR: Complete" + GLES32.GL_FRAMEBUFFER_COMPLETE);
        // System.out.println("RTR: undefined" + GLES32.GL_FRAMEBUFFER_UNDEFINED);
        // System.out.println("RTR: incomplete attachment" + GLES32.GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT);
        // System.out.println("RTR: incomplete missing attchment" + GLES32.GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT);
        // System.out.println("RTR: unsupported" + GLES32.GL_FRAMEBUFFER_UNSUPPORTED);
        // System.out.println("RTR: got" + check);

        GLES32.glBindFramebuffer(GLES32.GL_FRAMEBUFFER, 0);
        System.out.println("RTR: Added framebuffer facility...");
