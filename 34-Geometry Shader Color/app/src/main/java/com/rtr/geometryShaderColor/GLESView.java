package com.rtr.geometryShaderColor;
    ...
    private void initialize() {
        ...
        if (iShaderCompileStatus[0] == GLES32.GL_FALSE) {
            ...
            if (iInfoLogLength[0] > 0) {
                ...
                System.out.println("RTR: Geometry Shader: " + szInfo);
                uninitialize();
                System.exit(0);
            }
        }
        ...
        ////
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, colors.length * 4, colorBuffer, GLES32.GL_STATIC_DRAW);
