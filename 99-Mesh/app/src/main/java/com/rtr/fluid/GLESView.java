...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener {
    ...
    private void initialize() {
        ...
        ByteBuffer byteBuffer = ByteBuffer.allocateDirect(m*n*3*4);
        ...
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, m*n*3*4, null, GLES32.GL_DYNAMIC_DRAW);
        ...
        fluid = new Fluid(n, m, 0.05f, 0.5f, 100.0f, 0.5f);
    }
    ...
    private void display() {
        ...
        //GLES32.glUniform1f(timeUniform, time);

        // bind with vao (this will avoid many binding to vbo)
        GLES32.glBindVertexArray(vao[0]);  

        fluid.evaluate();
        float[] points = fluid.getResult();
        ...
        //
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, vbo[0]);
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, m*n*3*4, positionBuffer, GLES32.GL_DYNAMIC_DRAW);
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, 0);

        // draw necessary scene
        // for(int i = 0; i < m; i++) {
        //     GLES32.glDrawArrays(GLES32.GL_POINTS, i*m, n);
        // }

        GLES32.glDrawArrays(GLES32.GL_POINTS, 0, m*n);
